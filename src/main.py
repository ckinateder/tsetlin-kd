...
if __name__ == "__main__":
    ...
    downsample_experiments = [        
        ...
        # (mnist3d_dataset, "MNIST3D-Downsample", { "teacher_num_clauses": 1500, "student_num_clauses": 50, "T": 100, "s": 3.0, "teacher_epochs": 20, "student_epochs": 70 }, [0.01, 0.02, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45], {"overwrite": False}),
        (mnist3d_dataset, "MNIST3D-Downsample-Take-2-Long", { "teacher_num_clauses": 1500, "student_num_clauses": 250, "T": 100, "s": 3.0, "teacher_epochs": 100, "student_epochs": 300 }, [0.01, 0.02, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45], {"overwrite": False}),
        (kmnist_dataset, "KMNIST-Downsample-Take-2-Long", {"teacher_num_clauses": 1600, "student_num_clauses": 200, "T": 100, "s": 8.2, "teacher_epochs": 100, "student_epochs": 300 }, [0.01, 0.02, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45], {"overwrite": False}),
        (mnist_dataset, "MNIST-Downsample-Small-Long", {"teacher_num_clauses": 400, "student_num_clauses": 100, "T": 10, "s": 7.0,"teacher_epochs": 100, "student_epochs": 300 }, [0.01, 0.02, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45], {"overwrite": False}),
        (mnist_dataset, "MNIST-Downsample-Huge-Long", { "teacher_num_clauses": 3500, "student_num_clauses": 500, "T": 100, "s": 7.0,"teacher_epochs": 100, "student_epochs": 300 }, [0.01, 0.02, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45], {"overwrite": False}),
