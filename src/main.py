...
if __name__ == "__main__":
    ...
    downsample_experiments = [        
        ...
        (kmnist_dataset, "KMNIST-Downsample-Take-2", {"teacher_num_clauses": 1600, "student_num_clauses": 200, "T": 40, "s": 5.0, "teacher_epochs": 30, "student_epochs": 90 }, [0.01, 0.02, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45], {"overwrite": False}),
